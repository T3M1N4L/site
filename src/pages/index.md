...
<div class="interests-carousel-container">
  <div class="carousel-wrapper">
    <div class="interests-carousel">
      <div class="carousel-group">
        <button class="interest-btn">vex robotics</button>
        <button class="interest-btn">web development</button>
        <button class="interest-btn">internet uncensorship</button>
        <button class="interest-btn">music</button>
        <button class="interest-btn">pirating</button>
        <button class="interest-btn">gaming</button>
        <button class="interest-btn">pokemon</button>
        <button class="interest-btn">anime</button>
        <button class="interest-btn">graphic design</button>
      </div>
